...
public class RuleDiffServiceTest {
	...
	public void testDescriptionChange() {
		...
		SharedTrigger sharedTrigger = new SharedTrigger(TriggerType.ItemStateUpdated, properties, "Hello World", "Some Label", 0);
		SharedTrigger sharedTrigger2 = new SharedTrigger(TriggerType.ItemStateUpdated, new HashMap<>(properties), "Hello World2", "Some Label", 1);
	...
	public void testLabelChange() {
		...
		SharedTrigger sharedTrigger = new SharedTrigger(TriggerType.ItemStateUpdated, properties, "Hello World", "Some Label", 0);
		SharedTrigger sharedTrigger2 = new SharedTrigger(TriggerType.ItemStateUpdated, new HashMap<>(properties), "Hello World", "Some Label2", 1);
	...
	public void testAdd() {
		...
		SharedTrigger sharedTrigger = new SharedTrigger(TriggerType.ItemStateUpdated, properties, "Hello World", "Some Label", 0);
		SharedTrigger sharedTrigger2 = new SharedTrigger(TriggerType.ItemStateChanged, properties2, "Hello World", "Some Label", 1);
	...
	public void testRemove() {
		...
		SharedTrigger sharedTrigger = new SharedTrigger(TriggerType.ItemStateChanged, properties2, "Hello World", "Some Label", 0);
		SharedTrigger sharedTrigger2 = new SharedTrigger(TriggerType.ItemStateUpdated, properties, "Hello World", "Some Label", 1);
	...
	public void testUpdate() {
		...
		SharedTrigger sharedTrigger = new SharedTrigger(TriggerType.ItemStateUpdated, properties, "Hello World", "Some Label", 0);
		SharedTrigger sharedTrigger2 = new SharedTrigger(TriggerType.ItemStateUpdated, properties2, "Hello World", "Some Label", 1);
