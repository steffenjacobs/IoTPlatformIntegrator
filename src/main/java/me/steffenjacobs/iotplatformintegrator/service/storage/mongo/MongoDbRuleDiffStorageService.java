...
public class MongoDbRuleDiffStorageService {
	...
	public void findForRule(SharedRule rule, SimplifiedSubscriber<RuleDiffParts> subscriber) {
	...
	public void getAllDiffs(SimplifiedSubscriber<RuleDiffParts> subscriber) {
